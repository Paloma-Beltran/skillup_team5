        ...
        <div className="usuario contenedor">
            <div className="usuario__datos">
                ...
                <div className="usuario__informacion">
                    ...
                    {
                        //! Correo que puede ver el admin, las empresas para contactarlos y el dueño del perfil
                        usuario && (usuario.rol != "usuario" || uid == usuario.id) && <p className="usuario__correo">{datosUsuario.correo}</p>
                    }
